...
interface Props {
  ...
  onDelete: (user: AdminUserListItem, trigger: HTMLButtonElement) => void;
}
        ...
        <table className='w-full text-sm'>
          <thead className='bg-slate-900 text-white'>
            <tr>
              ...
              <th className='text-left px-6 py-4 font-medium hidden md:table-cell'>Time Spent</th>
                ...
                <td className='px-6 py-4'>
                  <div className='flex items-center gap-2'>
                    <button
                      ...
                      aria-label={`Check details for ${user.name}`}
                    ...
                    <button
                      onClick={(e) => onDelete(user, e.currentTarget)}
